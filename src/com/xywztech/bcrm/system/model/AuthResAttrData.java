...
/**
 * The persistent class for the AUTH_RES_ATTR_DATA database table.
 * @author wz
 * @since 2012-10-17
 */
@Entity
@Table(name="AUTH_RES_ATTR_DATA")
public class AuthResAttrData implements Serializable {
