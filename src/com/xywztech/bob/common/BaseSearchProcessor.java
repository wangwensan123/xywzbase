...
public abstract class BaseSearchProcessor {
	...
	protected JPAAnnotationMetadataUtil metadataUtil;

	protected String rootAlias = "_it";

	protected static final String ROOT_PATH = "";

	protected BaseSearchProcessor(int qlType, JPAAnnotationMetadataUtil metadataUtil) {
		if (metadataUtil == null) {
			throw new IllegalArgumentException("A SearchProcessor cannot be initialized with a null JPAAnnotationMetadataUtil.");
		}
		this.qlType = qlType;
	...
	/**
	 * The JPAAnnotationMetadataUtil used by this search processor. This can only be set in
	 * the constructor.
	 */
	 ...
	 */
	public String generateQL(Class<?> entityClass, Search search, List<Object> paramList) {
		if (entityClass == null)
	 ...
	 */
	public String generateRowCountQL(Class<?> entityClass, Search search, List<Object> paramList) {
		if (entityClass == null)
			throw new NullPointerException("The entity class for a search cannot be null");
